 ...
 */
public class testRectangleShape extends TestCase {
    ...
    public void testMove() throws Exception {
        ...
        //set up
        Shapeable o = new ShapeAdapter(new sprite.Shape(new sprite.RectangleStrategy()));
        o.setfX(0);
        o.setfY(50);
        o.setfDeltaX(-10);
        o.setfDeltaY(10);
    ...
    public void testContains() throws Exception{
        Shapeable d = new ShapeAdapter(new sprite.Shape(new sprite.RectangleStrategy()));
        d.setfX(0);
        d.setfY(50);
        d.setfDeltaX(-10);
        d.setfDeltaY(10);
