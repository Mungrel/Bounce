 ...
 */
public class testPacmanShape extends TestCase {
    ...
    public void testMove() throws Exception {
        ...
        //set up
        Shapeable o = new ShapeAdapter(new sprite.Shape(new sprite.PacmanStrategy()));
    ...
    public void testContains() throws Exception{
        Shapeable d = new ShapeAdapter(new sprite.Shape(new sprite.PacmanStrategy()));
        d.setfX(0);
        d.setfY(50);
        d.setfDeltaX(-10);
        d.setfDeltaY(10);
